...
<!-- Tambah Unit Pengolah Modal -->
<div id="tambahUnitPengolahModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        ...
        <div class="mt-3">
            ...
            <form id="addUnitForm">
                ...
                <div class="flex justify-end space-x-3">
                    <button type="button" onclick="closeModal('tambahUnitPengolahModal')" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 focus:outline-none">
                        Batal
                    </button>
