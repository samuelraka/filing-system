...
<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col ml-64">
        ...
        <div class="p-6 mt-16 overflow-y-auto flex flex-col gap-y-4">
            <h2 class="text-3xl font-medium text-gray-900 mb-4">Tambah Arsip Inaktif</h2>
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <form id="archiveForm" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Kategori Arsip -->
                             <div>
                                <label for="kategoriArsip" class="block text-sm font-medium text-gray-700 mb-1">Kategori Arsip</label>
                                <input type="text" id="kategoriArsip" name="kategoriArsip" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>

                            <!-- Kurun Waktu -->
                            <div>
                                <label for="kurunWaktu" class="block text-sm font-medium text-gray-700 mb-1">Kurun Waktu</label>
                                <input type="date" id="kurunWaktu" name="kurunWaktu" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="nomorBoks" name="nomorBoks" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>

                            <!-- Lokasi Simpan -->
                            <div>
                                <label for="lokasiSimpan" class="block text-sm font-medium text-gray-700 mb-1">Lokasi Simpan</label>
                                <input type="text" id="lokasiSimpan" name="lokasiSimpan" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>

                            <!-- Tingkat Perkembangan -->
                            <div>
                                <label for="tingkatPerkembangan" class="block text-sm font-medium text-gray-700 mb-1">Tingkat Perkembangan</label>
                                <input type="text" id="tingkatPerkembangan" name="tingkatPerkembangan" min="1" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
