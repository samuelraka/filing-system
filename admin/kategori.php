                    ...
                    <div id="content-pokok-masalah" class="tab-content">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white border border-gray-200 table-centered">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">1</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">PM-001</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">Contoh Pokok Masalah 1</span></td>
                                    ...
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">2</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">PM-002</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">Contoh Pokok Masalah 2</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200">
                                            <div class="action-buttons">
                                                <button class="text-yellow-600 hover:text-yellow-900">Edit</button>
                                                <button class="text-red-600 hover:text-red-900">Hapus</button>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white border border-gray-200 table-centered">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">1</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">SM-001</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">PM-001</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">Contoh Sub Masalah 1</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200">
                                            <div class="action-buttons">
                                                <button class="text-yellow-600 hover:text-yellow-900">Edit</button>
                                                <button class="text-red-600 hover:text-red-900">Hapus</button>
                                    ...
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">2</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">SM-002</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">PM-001</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">Contoh Sub Masalah 2</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200">
                                            <div class="action-buttons">
                                                <button class="text-yellow-600 hover:text-yellow-900">Edit</button>
                                                <button class="text-red-600 hover:text-red-900">Hapus</button>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white border border-gray-200 table-centered">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">1</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">SSM-001</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">SM-001</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">Contoh Sub-Sub Masalah 1</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200">
                                            <div class="action-buttons">
                                                <button class="text-yellow-600 hover:text-yellow-900">Edit</button>
                                                <button class="text-red-600 hover:text-red-900">Hapus</button>
                                    ...
                                    <tr>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">2</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">SSM-002</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">SM-001</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200"><span class="single-text">Contoh Sub-Sub Masalah 2</span></td>
                                        <td class="py-2 px-4 border-b border-gray-200">
                                            <div class="action-buttons">
                                                <button class="text-yellow-600 hover:text-yellow-900">Edit</button>
                                                <button class="text-red-600 hover:text-red-900">Hapus</button>
