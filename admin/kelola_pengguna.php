                    ...
                    <table class="min-w-full text-sm">
                        <thead>
                            <tr class="text-gray-500 border-b">
                                <th class="py-3 px-4 text-left font-medium text-xs uppercase tracking-wider">Nama</th>
...
<div id="tambahPenggunaModal" class="fixed inset-0 bg-gray-600/50  overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 w-[500px] shadow-lg rounded-md bg-white">
        <div class="mt-3">
...
<!-- Edit Pengguna Modal -->
<div id="editPenggunaModal" class="fixed inset-0 bg-gray-600/50  overflow-y-auto h-full w-full hidden z-50">
  <div class="relative top-20 mx-auto p-5 w-[500px] shadow-lg rounded-md bg-white">
    <div class="mt-3">
      <div class="flex items-center justify-between mb-4">
